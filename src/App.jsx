...
@keyframes blink{0%,100%{opacity:1}50%{opacity:0.3}}.progress-dot{animation:blink 1s infinite;font-size:8px}
...
.sessions-preview{display:flex;gap:8px;flex-wrap:wrap;justify-content:center;margin-bottom:24px}.session-chip{font-family:var(--mono);font-size:10px;padding:4px 10px;border:1px solid;border-radius:4px;display:flex;gap:6px}
...
.session-bar{display:flex;gap:4px;margin-bottom:16px;overflow-x:auto;padding-bottom:4px}.session-item{flex:1;min-width:100px;background:var(--bg2);border:1px solid var(--border);border-radius:6px;padding:8px 10px;text-align:center}.session-dot{width:6px;height:6px;border-radius:50%;margin:0 auto 4px}.session-name{font-size:9px;color:var(--text2);font-weight:500;margin-bottom:2px}.session-time{font-family:var(--mono);font-size:9px;color:var(--text3)}.session-countdown{font-family:var(--mono);font-size:10px;font-weight:600;margin-top:2px}
.verdict-card{background:var(--bg2);border:1px solid var(--border);border-radius:10px;padding:20px 24px;margin-bottom:16px;position:relative;overflow:hidden}.verdict-card::before{content:'';position:absolute;top:0;left:0;right:0;height:2px}.verdict-card.bull::before{background:linear-gradient(90deg,transparent,var(--green),transparent)}.verdict-card.bear::before{background:linear-gradient(90deg,transparent,var(--red),transparent)}.verdict-card.neutral::before{background:linear-gradient(90deg,transparent,var(--orange),transparent)}
.verdict-header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px;flex-wrap:wrap;gap:10px}.verdict-bias{font-family:var(--mono);font-size:20px;font-weight:700;letter-spacing:2px}.verdict-conf{font-family:var(--mono);font-size:10px;padding:3px 10px;border-radius:4px;font-weight:600}.verdict-summary{font-size:13px;line-height:1.7;color:var(--text);margin-bottom:14px}.verdict-levels{font-family:var(--mono);font-size:11px;color:var(--cyan);background:rgba(0,212,255,0.05);border:1px solid rgba(0,212,255,0.1);border-radius:6px;padding:10px 14px;margin-bottom:14px}
.scenarios{display:grid;grid-template-columns:1fr 1fr;gap:10px}.scenario{background:rgba(255,255,255,0.015);border:1px solid var(--border);border-radius:8px;padding:12px}.scenario-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:6px}.scenario-label{font-family:var(--mono);font-size:11px;font-weight:700}.scenario-prob{font-family:var(--mono);font-size:11px;font-weight:600}.scenario-trigger{font-size:10px;color:var(--text2);margin-bottom:3px}.scenario-target{font-family:var(--mono);font-size:10px;color:var(--cyan);margin-bottom:3px}.scenario-desc{font-size:10px;color:var(--text3)}
.session-recap{background:var(--bg2);border:1px solid var(--border);border-left:2px solid var(--cyan);border-radius:0 8px 8px 0;padding:12px 16px;margin-bottom:16px}.session-recap p{font-size:12px;line-height:1.6;color:var(--text)}
.pulse-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}.pulse-card{background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:12px}.pulse-label{font-family:var(--mono);font-size:9px;font-weight:600;color:var(--text3);letter-spacing:1.5px;margin-bottom:6px}.pulse-val{font-family:var(--mono);font-size:16px;font-weight:700}.pulse-text{font-size:11px;line-height:1.5;color:var(--text2)}
.intermarket{background:var(--bg2);border:1px solid var(--border);border-left:2px solid var(--orange);border-radius:0 8px 8px 0;padding:12px 16px;margin-bottom:16px}.intermarket p{font-size:11px;line-height:1.5;color:var(--text2)}
...
.movers-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(140px,1fr));gap:6px;margin-bottom:20px}.mover{background:var(--bg2);border:1px solid var(--border);border-radius:6px;padding:10px 12px;transition:all 0.15s}.mover:hover{transform:translateY(-1px);border-color:var(--border2)}.mover-top{display:flex;justify-content:space-between;align-items:center;margin-bottom:3px}.mover-name{font-family:var(--mono);font-size:11px;font-weight:600;color:#fff}.mover-pct{font-family:var(--mono);font-size:12px;font-weight:700}.mover-ctx{font-size:10px;color:var(--text3);line-height:1.3}
.filters{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:12px;flex-wrap:wrap}.filter-row{display:flex;gap:4px;flex-wrap:wrap}.fbtn{font-family:var(--mono);font-size:10px;padding:5px 10px;border-radius:4px;cursor:pointer;border:1px solid var(--border);background:transparent;color:var(--text3);transition:all 0.12s}.fbtn:hover{border-color:var(--border2);color:var(--text2)}.fbtn.active{border-color:var(--cyan);color:var(--cyan);background:rgba(0,212,255,0.06)}
...
.news-list{display:flex;flex-direction:column;gap:3px;margin-bottom:24px}.news-item{padding:10px 14px;background:var(--bg2);border-left:2px solid var(--border);border-radius:0 6px 6px 0;cursor:pointer;transition:all 0.12s}.news-item:hover{background:var(--bg3);transform:translateX(2px)}.news-head{display:flex;justify-content:space-between;align-items:center;gap:8px}.news-left{display:flex;align-items:center;gap:8px;flex:1;min-width:0}.news-right{display:flex;align-items:center;gap:10px;flex-shrink:0}.impact-tag{font-family:var(--mono);font-size:8px;font-weight:700;padding:2px 6px;border-radius:3px;flex-shrink:0}.news-title{font-size:12px;font-weight:500;color:#ddd;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.bias-tag{font-family:var(--mono);font-size:9px;font-weight:700}.news-time{font-family:var(--mono);font-size:9px;color:var(--text3);white-space:nowrap}
.news-body{margin-top:10px;padding-top:10px;border-top:1px solid var(--border)}.news-summary{font-size:11px;line-height:1.6;color:var(--text2);margin-bottom:8px}.news-tags{display:flex;gap:4px;flex-wrap:wrap;align-items:center}.inst-tag{font-family:var(--mono);font-size:9px;padding:2px 7px;border-radius:3px;background:rgba(0,212,255,0.06);border:1px solid rgba(0,212,255,0.1);color:var(--cyan)}.news-src{font-size:9px;color:var(--text3);font-style:italic;margin-left:auto}.empty-filter{padding:24px;text-align:center;color:var(--text3);font-size:12px}
.events-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:8px;margin-bottom:20px}.event-card{background:var(--bg2);border:1px solid var(--border);border-radius:8px;padding:14px}.event-top{display:flex;justify-content:space-between;align-items:center;margin-bottom:8px}.event-date{font-family:var(--mono);font-size:10px;color:var(--text3)}.event-name{font-size:13px;font-weight:600;color:#ddd;margin-bottom:6px}.event-row{font-size:10px;color:var(--text2);margin-bottom:3px;font-family:var(--mono)}.event-row span{color:var(--text)}.event-scenario{font-size:10px;line-height:1.4;margin-bottom:3px;padding:4px 8px;border-radius:4px}.event-bull{background:rgba(0,230,118,0.06);color:var(--green)}.event-bear{background:rgba(255,82,82,0.06);color:var(--red)}.event-affected{display:flex;gap:4px;flex-wrap:wrap;margin-top:8px}
@keyframes fadeUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.fade-up{animation:fadeUp 0.25s ease both}
...
.error-box{margin:8px 0;padding:10px 14px;background:rgba(255,82,82,0.06);border:1px solid rgba(255,82,82,0.15);border-radius:6px;font-size:11px;color:var(--red);display:flex;justify-content:space-between;align-items:center}.retry-btn{font-size:10px;padding:4px 10px;color:var(--red);border-color:rgba(255,82,82,0.3)}
.discord-toast{position:fixed;bottom:20px;right:20px;padding:10px 18px;border-radius:8px;font-family:var(--mono);font-size:11px;z-index:200;animation:fadeUp 0.3s ease}.discord-toast.sending{background:rgba(88,101,242,0.2);border:1px solid rgba(88,101,242,0.3);color:#7289da}.discord-toast.sent{background:rgba(0,230,118,0.15);border:1px solid rgba(0,230,118,0.25);color:var(--green)}.discord-toast.error{background:rgba(255,82,82,0.12);border:1px solid rgba(255,82,82,0.2);color:var(--red)}
